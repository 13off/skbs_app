...
void main() {
  test(
    'candidate workspace is a real configurable kanban over existing applications',
    () {
      final screen = source(
  ...
  test(
    'legacy stages remain deterministic for bots and existing automation',
    () {
  ...
  test('HR bottom navigation names the CRM as candidates', () {
    ...
    expect(
      source('docs/recruitment-crm.md'),
      contains('recruitment_status_history'),
    );
  });
}
