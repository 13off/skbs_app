...
void main() {
  test(
    'foreman can edit checklist names and delete checklist items or goals',
    () {
      final detail = source(
      ...
      expect(
        detail,
        contains('widget.profile.isAdmin || widget.profile.isForeman'),
      );
      expect(repository, contains('deleteMilestone'));
      expect(
        migration,
        contains('is_foreman() and can_access_object(object_name)'),
      );
    },
  );
