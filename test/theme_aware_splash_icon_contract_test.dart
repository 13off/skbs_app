...
void main() {
  test('saved theme is synchronized before and after Flutter starts', () {
    ...
    expect(
      controller,
      contains('await AppThemePlatformSync.apply(isDark: isDark)'),
    );
    expect(
      controller,
      contains('await AppThemePlatformSync.apply(isDark: value)'),
    );
    expect(
      platform,
      contains("if (dart.library.html) 'theme_platform_sync_web.dart'"),
    );
    expect(
      platform,
      contains("if (dart.library.io) 'theme_platform_sync_io.dart'"),
    );
  ...
  test(
    'Android splash and launcher aliases follow the stored Flutter theme',
    () {
