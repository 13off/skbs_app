...
void main() {
  test(
    'desktop directory receives a clean position without losing phone data',
    () {
  ...
  test(
    'shared AppPage expands on desktop and restores nested back navigation',
    () {
      ...
      expect(
        tokens,
        contains('static const double pageDesktopHorizontalPadding = 36;'),
      );
