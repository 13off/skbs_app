...
void main() {
  test('global voice overlay is mounted above the authenticated app', () {
    final bridge = File(
      'lib/navigation/web_back_navigation.dart',
    ).readAsStringSync();
    final authOverlay = File(
      'lib/features/ai/presentation/global_voice_assistant_auth_overlay.dart',
    ).readAsStringSync();

    expect(bridge, contains('GlobalVoiceAssistantAuthOverlay'));
