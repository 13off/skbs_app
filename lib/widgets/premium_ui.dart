        ...
        child: AnimatedSwitcher(
          ...
          child: isLoading
              ? const Center(
                  ...
                  child: _PremiumDots(color: Colors.white),
                )
              : Row(
  ...
  Widget build(BuildContext context) {
    return DecoratedBox(
      ...
      child: Stack(
        fit: StackFit.expand,
        children: [
          const RepaintBoundary(child: CustomPaint(painter: _BlueprintPainter())),
          Positioned(
            top: -110,
            right: -70,
            child: IgnorePointer(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const _PremiumDots(color: AppColors.textPrimary),
                ],
              ),
            ),
          ),
...
class _PremiumDots extends StatefulWidget {
  ...
  const _PremiumDots({required this.color});

  @override
  State<_PremiumDots> createState() => _PremiumDotsState();
}

class _PremiumDotsState extends State<_PremiumDots>
    with SingleTickerProviderStateMixin {
  late final AnimationController controller;
