...
class WorkOrderRepository {
  ...
  static List<String> unitOptions([String? current]) {
    final clean = current?.trim() ?? '';
    if (clean.isEmpty || supportedUnits.contains(clean)) {
      return supportedUnits;
    }
    return <String>[clean, ...supportedUnits];
  }
  ...
  static Future<Map<String, dynamic>?> day(String taskId, DateTime date) => _db
      .from('task_work_days')
      .select()
      .eq('task_id', taskId)
