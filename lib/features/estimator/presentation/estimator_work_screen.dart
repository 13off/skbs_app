...
class EstimatorWorkScreen extends StatefulWidget {
  const EstimatorWorkScreen({super.key});

  @override
  State<EstimatorWorkScreen> createState() => _EstimatorWorkScreenState();
}

class _EstimatorWorkScreenState extends State<EstimatorWorkScreen> {
