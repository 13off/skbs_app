...
def main() -> int:
    ...
    try:
        ...
        # Prime exactly like a real installed PWA: open online, wait until the
        # worker is active, reopen once under worker control, then remove the
        # network and perform a fresh navigation back to the application.
        driver.get(url)
