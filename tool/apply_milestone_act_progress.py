...
generator = 'lib/data/act_generator.dart'
replace_once(
    generator,
...
replace_once(
    ...
    '_buildWorksXml(tasks, contextByTaskId)',
)
replace_once(
    generator,
...
""",
    '_goalProgressSentence(TaskActContext context)',
)

detail = 'lib/features/milestones/presentation/milestone_detail_screen.dart'
replace_once(
    detail,
